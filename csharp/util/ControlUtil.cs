...
namespace cSharpProfiler.csharp.util
{
    class ControlUtil
    {
        static public void ApplyDefaults(Control control)
        {
            control.RectClipContent = true;

            //control.MarginLeft = 0;
            //control.MarginTop = 0;
            //control.MarginRight = 0;
            //control.MarginBottom = 0;
            control.AnchorLeft = 0;
            control.AnchorTop = 0;
            control.AnchorRight = 0;
            control.AnchorBottom = 0;
            control.SizeFlagsHorizontal = (int)SizeFlags.Fill;
            control.SizeFlagsVertical = (int)SizeFlags.Fill;
        }
        ...
        static public void ApplyFullExpands(Control control)
        {
            ...
            control.SizeFlagsVertical = (int)SizeFlags.ExpandFill;
        }
